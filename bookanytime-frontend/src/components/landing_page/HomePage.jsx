    ...
    <div className="d-flex flex-column min-vh-100">
      <main className="flex-grow-1">
        ...
        <section className="position-relative vh-100 bg-dark text-white">
          ...
          <div className="position-absolute top-0 start-0 w-100 h-100 z-0 overflow-hidden" style={{marginTop: '-200px'}}>
            <img 
          ...
          <div className="container mx-auto h-100 d-flex align-items-center position-relative z-1">
            <div className={`row justify-content-start align-items-center
              ...
              <div className="col-12 col-md-8 col-lg-6 text-start">
                <h2 className="fs-1 fs-md-1 fs-lg-2 fw-bold mb-3 mb-md-4 text-nowrap" style={{marginTop: '-180px'}}>
